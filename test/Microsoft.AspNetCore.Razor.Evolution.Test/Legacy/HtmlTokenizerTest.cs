...
namespace Microsoft.AspNetCore.Razor.Evolution.Legacy
{
    public class HtmlTokenizerTest : HtmlTokenizerTestBase
    {
        ...
        {
            TestTokenizer("\n\r\r\n",
                          new HtmlSymbol("\n", HtmlSymbolType.NewLine) { Offset = 0 },
                          new HtmlSymbol("\r", HtmlSymbolType.NewLine) { Offset = 1 },
                          new HtmlSymbol("\r\n", HtmlSymbolType.NewLine) { Offset = 2 });
        }
        ...
        public void Next_Ignores_Star_At_EOF_In_RazorComment()
        {
            TestTokenizer(
                "@* Foo * Bar * Baz *",
                new HtmlSymbol("@", HtmlSymbolType.RazorCommentTransition) { Offset = 0 },
                new HtmlSymbol("*", HtmlSymbolType.RazorCommentStar) { Offset = 1 },
                new HtmlSymbol(" Foo * Bar * Baz *", HtmlSymbolType.RazorComment) { Offset = 2 });
        }
        ...
        public void Next_Ignores_Star_Without_Trailing_At()
        {
            TestTokenizer(
                ...
                new HtmlSymbol("*", HtmlSymbolType.RazorCommentStar) { Offset = 1 },
                new HtmlSymbol(" Foo * Bar * Baz ", HtmlSymbolType.RazorComment) { Offset = 2 },
                new HtmlSymbol("*", HtmlSymbolType.RazorCommentStar) { Offset = 19 },
                new HtmlSymbol("@", HtmlSymbolType.RazorCommentTransition) { Offset = 20 });
        }
        ...
        public void Next_Returns_RazorComment_Token_For_Entire_Razor_Comment()
        {
            TestTokenizer(
                ...
                new HtmlSymbol("*", HtmlSymbolType.RazorCommentStar) { Offset = 1 },
                new HtmlSymbol(" Foo Bar Baz ", HtmlSymbolType.RazorComment) { Offset = 2 },
                new HtmlSymbol("*", HtmlSymbolType.RazorCommentStar) { Offset = 15 },
                new HtmlSymbol("@", HtmlSymbolType.RazorCommentTransition) { Offset = 16 });
        }
    }
}
